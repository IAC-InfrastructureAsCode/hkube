...
describe('API-Server', () => {
    ...
    storageAdapters.forEach(s => {
        describe(`API-Server with ${s}`, () => {
            before(async () => {
                config.defaultStorage = s;
                    ...
                    describe('ReadMe', () => {
                        describe('/pipelines', () => {
                            ...
                            it('should success to update readme', async () => {
                                ...
                                const response1 = await _request(insert);
                                expect(response1.body).to.have.property('path');
                                expect(response1.response.statusCode).to.equal(201);
                                ...
                                const response2 = await _request(put);
                                ...
                                const response3 = await _request(get);
